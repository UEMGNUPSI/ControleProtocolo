...
<head>
  ...
  <title>Protocolos</title>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <script type="text/javascript" src="js/funcs_nomes_coleg.js"></script>
           ...
           <div class="row">
            ...
            <div class="col-12">
                ...
                <form class="form-inline mb-3 "  >
                  <input class="form-control ml-5" type="search" placeholder="Buscar..." id="buscanome"  onkeyup="buscarColegiado(this.value)">
